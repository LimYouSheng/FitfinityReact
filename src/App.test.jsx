...
it('restores nested trainer assigned-client filters after returning from a client profile', async () => {
  ...
  expect(assigned.querySelectorAll('.compact-list-row')).toHaveLength(10)
  click('Next')
  expect(assigned.querySelectorAll('.compact-list-row')).toHaveLength(3)
  ...
  fireEvent.click(within(screen.getByLabelText('Assigned client list')).getByRole('button', { name: 'View Amanda Lim' }))
  await screen.findByRole('heading', { name: 'Amanda Lim' })
  profileTab('Progress')
  click('Back')
  await screen.findByRole('heading', { name: 'Assigned Clients' })
