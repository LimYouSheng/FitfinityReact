...
afterEach(cleanup)
it.each([['pending','Pending','amber'],['approved','Approved','green'],['rejected','Rejected','red']])('renders readable %s approval status in its assigned colour', (status,label,tone)=>{
