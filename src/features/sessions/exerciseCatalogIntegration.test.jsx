...
it('keeps a saved inactive exercise name when editing another plan field', async () => {
  ...
  render(<ActionConfirmationProvider><ExercisePlanEditor catalog={catalog} items={[{ id: 'old', name: 'Historical movement', weight: '10 kg', reps: '8', rounds: '2', rest: '60 sec' }]} editing canEdit onSave={onSave} onEndEdit={vi.fn()} /></ActionConfirmationProvider>)
